...
void optgen(){
    //=================optimization=================
    //===========reduce the unreachable code===============
    
    
    //===========handle the constant propagation============
...
int main(int argc, char **argv)
{
    ...
    if (sematic_error==0) {
        ...
        if ((codeoutput = fopen(ass_name,"wb")) == NULL) {
            printf("Cannot create Assembly output file.Please check the previlige.\n");
        }
        else{
            printf("------Assembly File Generator started!------ \n");
        };
        codegen();
        fclose(codeoutput);
        printf("=======Code was successfully generated! Please check <name>.s under workdir=========\n");
